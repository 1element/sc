...
public class SurveillanceApiControllerTest {
  ...
  public void testRecordingsList() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/recordings").cookie(tokenCookie))
      .andExpect(status().isOk())
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[0].fileName", is("filename.jpg")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[0].cameraId", is("camera1")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[0].receivedAt", is("2018-01-27T12:48:45")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[0].archived", is(false)))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[1].fileName", is("filename2.jpg")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[1].cameraId", is("camera2")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[1].receivedAt", is("2018-01-27T12:48:45")))
      .andExpect(jsonPath("$._embedded.surveillanceImageResourceList[1].archived", is(false)))
